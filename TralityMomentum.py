...
def initialize(state):
    state.signals = {}
    state.cooler = {"KSMUSDT":0, "ONTUSDT":0, "SOLUSDT":0, "IOTAUSDT":0, "AVAXUSDT":0, "RUNEUSDT":0}
    state.buyer = {"KSMUSDT":0, "ONTUSDT":0, "SOLUSDT":0, "IOTAUSDT":0, "AVAXUSDT":0, "RUNEUSDT":0}
    state.tp_newposition =  {"KSMUSDT":False, "ONTUSDT":False, "SOLUSDT":False, "IOTAUSDT":False, "AVAXUSDT":False, "RUNEUSDT":False}
    state.tp_position =  {"KSMUSDT":0, "ONTUSDT":0, "SOLUSDT":0, "IOTAUSDT":0, "AVAXUSDT":0, "RUNEUSDT":0}
    state.signal_parameters = [22, 14, 30, 14, 14]
    
SYMBOLS = ["KSMUSDT", "ONTUSDT", "SOLUSDT"]
SYMBOLS2 = ["IOTAUSDT", "AVAXUSDT", "RUNEUSDT"]
